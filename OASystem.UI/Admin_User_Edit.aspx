...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <p>
            <asp:Button ID="btnSubmit" runat="server" Text="修改" CssClass="btn btn-primary" OnClick="btnSubmit_Click" /> <asp:Button CssClass="btn btn-danger" ID="btnDelete" runat="server" Text="删除员工" /></p>
    </div>
</asp:Content>
